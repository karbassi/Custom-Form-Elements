...
'" '+g+'">'+d+"</span>";a(d).insertBefore(this)}})},bind:function(){var b=this;a("span."+b.options.uniqueClassName+".checkbox:not(.disabled), span."+b.options.uniqueClassName+".radio:not(.disabled)").live("mousedown",function(d){b.mousedown(d,this)}).live("mouseup",function(d){b.mouseup(d,this)});a("span."+b.options.uniqueClassName+".select:not(.disabled) + select").live("change",function(){a(this).prev("span").text(a("option:selected",this).text())});a("input").live("change",function(){b.reset()})},
